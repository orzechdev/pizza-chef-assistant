...
@Database(entities = {Pizza.class, Order.class, Customer.class, Ingredient.class, PizzaIngredient.class, OrderPizza.class}, version = 16)
...
public abstract class MainDatabase extends RoomDatabase {
    ...
    public abstract InitDao initDao();
}