...
//    Retrofit retrofit;
    ...
    private void initSampleData() {
        ...
        orders.add(new Order(43,false, "21:23:12", "Krzywa 2/8"));
        orders.add(new Order(44,false, "21:23:15", "Krzywa 2/3"));
        orders.add(new Order(45,false, "21:24:12", "Krzywa 2/6"));
        orders.add(new Order(46,false, "21:26:12", "Krzywa 7/6"));
        orders.add(new Order(47,false, "21:28:12", "Krzywa 2/81"));
        orders.add(new Order(48,false, "21:35:12", "Krzywa 2/58"));
        orders.add(new Order(49,false, "21:55:12", "Krzywa 2/84"));
        ...
        orderPizzas.add(new OrderPizza(46, 24, 2));
